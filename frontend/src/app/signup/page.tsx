    ...
    <div className="flex min-h-screen bg-zinc-950 items-center justify-center p-4 font-sans selection:bg-zinc-800 selection:text-zinc-100">
      <div className="w-full max-w-[360px] flex flex-col gap-6">
        <div className="flex flex-col items-center mb-2">
          ...
          <h1 className="text-xl font-medium tracking-tight text-zinc-100">Create an account</h1>
        </div>
        ...
        <p className="text-center text-sm text-zinc-500">
          Already have an account? <Link href="/login" className="text-zinc-300 hover:text-white font-medium transition-colors">Sign in</Link>
        </p>
      </div>
    </div>
  );
